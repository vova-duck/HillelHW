...
public class University {
    ...
    public static void main(String[] args) {
        ArrayList<Student> students = createStudent();

            System.out.println("Студенты факультета Право");
            for (int i = 0; i < students.size() -1 ; i++) {
                if (students.get(i).getFaculty().equals("Право")){
            ...
            for (int i = 0; i < students.size()-1; i++) {
                if (students.get(i).getGroup() == 314){
                    System.out.println(students.get(i));}
            }
    ...
    public static ArrayList<Student> createStudent() {
        int numberOfStudents = (int) ((Math.random() * 20) +10);
